...
Vagrant.configure("2") do |config|
  ...
  # config.vm.network "forwarded_port", guest: 46353, host: 46353
  ...
  # config.vm.network "forwarded_port", guest: 8000, guest_ip: "127.0.0.1", host: 8000
  # config.vm.network "forwarded_port", guest: 8080, guest_ip: "127.0.0.1", host: 8080
  # config.vm.network "forwarded_port", guest: 8081, guest_ip: "127.0.0.1", host: 8081
